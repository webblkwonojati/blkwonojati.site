...
export default function HomeVideo() {
  ...
  return (
    <section className="py-24 px-6 relative bg-transparent overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100vw] h-[100vw] opacity-20 pointer-events-none">
        <img src="/gradien-1.png" alt="" loading="lazy" aria-hidden="true" className="w-full h-full object-contain blur-3xl rotate-90" />
      </div>
