          ...
          <div className="mx-auto max-w-4xl relative z-10">
            ...
            {program.hero_image && (
              <div className="mt-10 overflow-hidden relative group">
                <div className="flex w-full overflow-x-auto snap-x snap-mandatory no-scrollbar rounded-[1.5rem] md:rounded-[2rem] border-4 border-white shadow-xl bg-slate-100 flex-nowrap">
                  {program.hero_image.split(',').map((url: string, idx: number) => (
                    <div key={idx} className="w-full shrink-0 snap-center relative flex justify-center items-center overflow-hidden">
                      <Image
                        ...
                        width={1200}
                        height={800}
                        className="w-full h-[50vh] md:h-[60vh] object-contain bg-slate-900/5"
                        priority={idx === 0}
                      />
                    </div>
                  ))}
